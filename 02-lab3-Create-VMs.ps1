...
$resourceGroupName = 'tarkett2-vms-rg'
$vnetResourceGroupName = 'tarkett2-net-rg'
$vnetName = 'demovnet'
...
# Corrected command
az vm create --image Ubuntu2204 --location $location --name linuxjumpbox --resource-group $resourceGroupName --size Standard_B1ms --subnet $jumpboxSubnetId --nsg '""' --public-ip-sku Standard --output table 
...
<#
Generated SSH certificate C:\Users\<USERNAME>\.ssh\az_ssh_config\<PublicIP>\id_rsa.pub-aadcert.pub is valid until 2023-09-13 09:54:39 PM in local time.
C:\Users\<USERNAME>\.ssh\az_ssh_config\<PublicIP> contains sensitive information (id_rsa, id_rsa.pub, id_rsa.pub-aadcert.pub). Please delete it once you no longer need this config file.
#>
cat ~/.ssh/config
